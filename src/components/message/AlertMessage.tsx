  ...
  return (
    <div
      className={clsx(
        ...
        type == 'danger' ? 'bg-red-100 text-red-500/90 dark:bg-red-100/0 dark:text-red-500' : '',
        type == 'warning' ? 'bg-amber-100 text-amber-500/90 dark:bg-amber-100/0 dark:text-amber-500' : '',
        type == 'info' ? 'bg-cyan-100 text-cyan-500/90 dark:bg-cyan-100/0 dark:text-cyan-500' : '',
        'w-full'
      )}
    >
