...
import { default as cycleAirdropData } from './data/cycle4.json';
  ...
  return (
    <div>
      <Card title="" extra="w-full mb-2 md:col-span-1 sm:overflow-auto px-3 py-2 sm:px-6 sm:py-4">
        <h3 className="mb-2">
          <span className="text-bold text-xl">Cycle 4 (2024-07-12 → 2024-08-09)</span>
        ...
        <p className="mb-1 italic opacity-50">In this epoch, rewards are computed in a similar fashion to Cycle 3.</p>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr>
                          ...
                          {marketsConfig[appChainId].map((marketConfig, i) => {
                            const creditTokenSymbol = 'g' + marketConfig.pegToken;

                            return (
                              <th key={i} className="whitespace-nowrap text-center" colSpan={2}>
                                <Image
                        ...
                        <tr>
                          {marketsConfig[appChainId].map((o, i) => [
                            <th key={i + '-l'} className="px-2 py-1 text-center">
                              L
                            </th>,
                            <th key={i + '-b'} className="px-2 py-1 text-center">
                              B
                            </th>
                          ])}
                        </tr>
                      ...
                      <tbody>
                        {Object.keys(data.userData[o.userAddress]?.dailyBalances || {}).map((date, i) => (
                          <tr key={i}>
