...
export const style = {
  ...
  transferPropContainer:
    'bg-transparent my-3 rounded-md p-4 text-lg border dark:border-white hover:border-[#41444F]  flex justify-between items-center',
