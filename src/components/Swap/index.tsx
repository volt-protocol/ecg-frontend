...
const style = {
  ...
  content: `bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 w-full  rounded-2xl p-4 text-white`,
    ...
    <div className={style.content}>
      ...
      <div className={style.transferPropContainer}>
        <input
          ...
          placeholder={allocatedGuild.toString()}
          pattern="^[0-9]*[.,]?[0-9]*$"
          value={allocatedGuild}
          disabled
        />
        
        <div className="w-full">Your current guild allocated</div>
      </div>
      <div className={style.transferPropContainer}>
        <input
        ...
        <div className="w-full justify-end text-xl">
          {textButton === "Increment" ? (<p> Guild you want to allocate</p>):(<p> Guild you want to withdraw</p>)}
