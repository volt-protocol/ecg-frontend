  ...
  return (
    <Card title="" extra="w-full min-h-[300px] md:col-span-1 sm:overflow-auto px-3 py-2 sm:px-6 sm:py-4">
      ...
      <p className="mb-1 italic opacity-50">
        In this epoch, a constant amount of rewards is allocated to each day. Stakers who have more (lend + stake) than
        borrow on any given day are considered "lenders" for this day, and earn the lender rewards for this day, on top
        of the staker rewards.
      </p>
                    ...
                    <tbody>
                      {Object.keys(data[o.userAddress].dailyBalances).map((date) => (
                        <tr>
                          ...
                          {marketsConfig[appChainId].map((marketConfig) => {
                            const d =
                              data[o.userAddress].dailyBalances[date]['market_' + marketConfig.marketId] || ({} as any);
                            return [
                              <td
                                className={
