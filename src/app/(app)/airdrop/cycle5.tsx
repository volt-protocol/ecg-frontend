...
import { default as cycleAirdropData } from './data/cycle5.json';
  ...
  return (
    <div>
      <Card title="" extra="w-full mb-2 md:col-span-1 sm:overflow-auto px-3 py-2 sm:px-6 sm:py-4">
        <h3 className="mb-2">
          <span className="text-bold text-xl">Cycle 5 (2024-08-09 → 2024-09-06)</span>
        ...
        <p className="mb-1 italic opacity-50">In this epoch, rewards are computed in a similar fashion to Cycle 4.</p>
