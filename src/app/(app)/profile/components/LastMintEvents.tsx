      ...
      cell: (info) => {
        return (
          <>
            <span
              className={clsx(
                info.getValue() == 'Mint' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800',
      ...
      cell: (info) => {
        return (
          <div className="ml-4 text-sm ">
            ...
            />{' '}
            <span className="mr-1 font-semibold">{formatDecimal(info.getValue(), pegTokenDecimalsToDisplay)}</span>
          </div>
        );
      }
    }),
