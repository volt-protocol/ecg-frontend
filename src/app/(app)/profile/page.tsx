...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    search != "" && isAddress(search)
      ? setUserAddress(search as Address)
    ...
    <div>
              ...
              {loadingLoans || loadingRecent ? (
                ...
                <>
                  ...
                  <span className="text-stone-700 dark:text-stone-200">
                    {underscoreToString(
                      getUserLevel(userLoansData, lastMints, lastVotes)
                    )}
                  </span>{" "}
                </>
              )}
      ...
      <div className="flex justify-end">
        <div className="flex items-center gap-1 text-xs font-light text-stone-400 dark:text-stone-100">
          ...
          <a
            className="cursor-pointer text-stone-400 dark:text-stone-100"
            ...
            <span className="isolate inline-flex rounded-md shadow-sm">
              ...
              >
                ...
                <span className="rounded-full bg-stone-100 px-1.5 py-0.5 text-xs font-medium text-stone-500">
                  {userLoansData &&
                    userLoansData.filter((loan) => loan.closeTime == 0).length}
                </span>
              </button>
              <button
                type="button"
